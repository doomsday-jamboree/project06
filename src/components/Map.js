...
class Map extends Component {
  getMap = () => {
    if (this.props.choice === 'alex') {
      return (
        <div className='bunkerDescriptions'>
          <h2 className='bunkerOwner'>Alex's Bunker</h2>
          <p>
            ...
            customer base. The compound consists of a cinema, indoor pool
      ...
      return (
        <div className='bunkerDescriptions'>
          <h2 className='bunkerOwner'>Glen's Bunker</h2>
          <p>
      ...
      return (
        <div className='bunkerDescriptions'>
          <h2 className='bunkerOwner'>Oiza's Bunker</h2>
          <p>
      ...
      return (
        <div className='bunkerDescriptions'>
          <h2 className='bunkerOwner'>Zoe's Bunker</h2>
          <p>
